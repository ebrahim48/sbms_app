...
class _CustomTextFieldState extends State<CustomTextField> {
    ...
    return Padding(
      ...
      child: Column(
        ...
        decoration: InputDecoration(
            ...
            hintStyle: TextStyle(color: widget.hintextColor ?? AppColors.textColor5D5D5D, fontSize: widget.hintextSize ?? 12.h,fontWeight: FontWeight.w400),
  ...
  _suffixIcon(IconData icon) {
    return Padding(padding: const EdgeInsets.all(12.0), child: Icon(icon,color:AppColors.textColor5D5D5D));
  }
